...
\merke{Der größte Nutzen der eigenen Aufnahme liegt nicht im Training, sondern
in der Bewertung: Sie liefert die \emph{erste zurückgehaltene echte Mischung}
des Projekts. Als Trainingsmaterial taugt sie nur ausschnittweise, mit
Zeitausgleich und einer Mindestgüte der Rückrechnung -- und sie behebt nicht
das eigentliche Problem, den Pegel.}
...
\begin{itemize}
  ...
  \item \textbf{Wenig echte Referenzen.} Zwei echte Mischungen reichen nicht,
    um stückabhängige Pegelentscheidungen zu lernen, und es gibt bisher keine
    zurückgehaltene echte Mischung als Testfall. Die Wuppertaler Aufnahme kann
    diese Lücke schließen (Abschnitt~\ref{sec:eigene}).
\end{itemize}
